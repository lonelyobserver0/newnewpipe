package org.newnewpipe.app.util.image;

import static org.newnewpipe.extractor.Image.HEIGHT_UNKNOWN;
import static org.newnewpipe.extractor.Image.WIDTH_UNKNOWN;
...
public final class ImageStrategy {
    ...
    static String choosePreferredImage(@NonNull final List<Image> images,
        ...
        // unreachable
        Comparator<Image> finalComparator;
        switch (nonNoneQuality) {
            case NONE:
                finalComparator = initialComparator;
                break;
            case LOW:
