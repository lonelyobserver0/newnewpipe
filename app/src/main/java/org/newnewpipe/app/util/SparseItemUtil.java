...
import static org.newnewpipe.extractor.stream.StreamType.AUDIO_LIVE_STREAM;
import static org.newnewpipe.extractor.stream.StreamType.LIVE_STREAM;
...
public final class SparseItemUtil {
     ...
     * org.newnewpipe.extractor.feed.FeedExtractor}. FeedExtractors provide a fast and
     * lightweight method to fetch info, but the info might be incomplete (see
     * {@link org.newnewpipe.app.local.feed.service.FeedLoadService} for more details).
     *
     ...
     *                 org.newnewpipe.extractor.stream.StreamInfo}
     */
     ...
     * org.newnewpipe.extractor.feed.FeedExtractor}). A toast is shown if loading details is
     * required.
     *
     * @param context     Android context
     ...
     *                    org.newnewpipe.extractor.stream.StreamInfo} corresponding to the item
     */
