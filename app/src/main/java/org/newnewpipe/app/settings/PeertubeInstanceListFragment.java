...
import org.newnewpipe.app.util.PeertubeHelper;
...
public class PeertubeInstanceListFragment extends Fragment {
    ...
    private void selectInstance(final PeertubeInstance instance) {
        // Scelta esplicita dell'utente: il failover automatico (022-S9) la rispetta.
        selectedInstance = PeertubeHelper.selectInstanceManual(instance, requireContext());
