package org.newnewpipe.app.database.stream.model;
...
import static org.newnewpipe.app.database.stream.model.StreamStateEntity.JOIN_STREAM_ID;
...
public class StreamStateEntity {
     ...
     * (60000ms = 60s).
     * @see #isFinished(long)
     * @see org.newnewpipe.app.database.feed.dao.FeedDAO#getLiveOrNotPlayedStreams()
     * @see org.newnewpipe.app.database.feed.dao.FeedDAO#getLiveOrNotPlayedStreamsForGroup(long)
     */
