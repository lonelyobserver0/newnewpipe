...
import org.newnewpipe.extractor.timeago.PatternsHolder;
import org.newnewpipe.extractor.timeago.TimeAgoUnit;
    ...
    public static void main(String[] args) throws FileNotFoundException, JsonParserException {
        ...
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            ...
            try (final FileWriter fileOut = new FileWriter(
                    "timeago-parser/src/main/java/org/newnewpipe/extractor/timeago/patterns/" +
                            languageCode + ".java")) {
                final String test = INFO_CLASS_GENERATED + "\n" +
                        "\n" +
                        "package org.newnewpipe.extractor.timeago.patterns;\n\n" +
                        "import org.newnewpipe.extractor.timeago.PatternsHolder;\n" +
                        (specialCasesString.length() > 0 ? "import org.newnewpipe.extractor.timeago.TimeAgoUnit;\n" : "") +
                        "\n" +
