...
import org.newnewpipe.extractor.bulletComments.BulletCommentsExtractor;
import org.newnewpipe.extractor.search.filter.FilterItem;
import org.newnewpipe.extractor.services.youtube.extractors.YoutubeBulletCommentsExtractor;
import org.newnewpipe.extractor.services.youtube.linkHandler.YoutubeBulletCommentsLinkHandlerFactory;
import org.newnewpipe.extractor.services.youtube.search.filter.YoutubeFilters;

import static java.util.Arrays.asList;
import static org.newnewpipe.extractor.StreamingService.ServiceInfo.MediaCapability.*;
...
import org.newnewpipe.extractor.services.youtube.extractors.YoutubeChannelExtractor;
import org.newnewpipe.extractor.services.youtube.extractors.YoutubeChannelTabExtractor;
import org.newnewpipe.extractor.services.youtube.extractors.YoutubeCommentsExtractor;
import org.newnewpipe.extractor.services.youtube.extractors.YoutubeFeedExtractor;
import org.newnewpipe.extractor.services.youtube.extractors.YoutubeMixPlaylistExtractor;
import org.newnewpipe.extractor.services.youtube.extractors.YoutubeMusicSearchExtractor;
import org.newnewpipe.extractor.services.youtube.extractors.YoutubePlaylistExtractor;
import org.newnewpipe.extractor.services.youtube.extractors.YoutubeSearchExtractor;
import org.newnewpipe.extractor.services.youtube.extractors.YoutubeStreamExtractor;
import org.newnewpipe.extractor.services.youtube.extractors.YoutubeSubscriptionExtractor;
import org.newnewpipe.extractor.services.youtube.extractors.YoutubeSuggestionExtractor;
import org.newnewpipe.extractor.services.youtube.extractors.YoutubeTrendingExtractor;
import org.newnewpipe.extractor.services.youtube.linkHandler.YoutubeChannelLinkHandlerFactory;
import org.newnewpipe.extractor.services.youtube.linkHandler.YoutubeChannelTabLinkHandlerFactory;
import org.newnewpipe.extractor.services.youtube.linkHandler.YoutubeCommentsLinkHandlerFactory;
import org.newnewpipe.extractor.services.youtube.linkHandler.YoutubePlaylistLinkHandlerFactory;
import org.newnewpipe.extractor.services.youtube.linkHandler.YoutubeSearchQueryHandlerFactory;
import org.newnewpipe.extractor.services.youtube.linkHandler.YoutubeStreamLinkHandlerFactory;
import org.newnewpipe.extractor.services.youtube.linkHandler.YoutubeTrendingLinkHandlerFactory;
